...
C_SRCS += \
../FIFO_Queue/Src/fifo_queue.c 

C_DEPS += \
./FIFO_Queue/Src/fifo_queue.d 

OBJS += \
./FIFO_Queue/Src/fifo_queue.o 


# Each subdirectory must supply rules for building sources it contributes
FIFO_Queue/Src/%.o FIFO_Queue/Src/%.su FIFO_Queue/Src/%.cyclo: ../FIFO_Queue/Src/%.c FIFO_Queue/Src/subdir.mk
...
clean: clean-FIFO_Queue-2f-Src

clean-FIFO_Queue-2f-Src:
	-$(RM) ./FIFO_Queue/Src/fifo_queue.cyclo ./FIFO_Queue/Src/fifo_queue.d ./FIFO_Queue/Src/fifo_queue.o ./FIFO_Queue/Src/fifo_queue.su

.PHONY: clean-FIFO_Queue-2f-Src
